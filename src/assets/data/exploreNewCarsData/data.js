...
const carLogos = [
    { id: 1, name: "Maruti", logo: "../../src/assets/images/Logos/Current/maruti.jpg" },
    { id: 2, name: "Tata", logo: "../../src/assets/images/Logos/Current/tata.jpg" },
    { id: 3, name: "Kia", logo: "../../src/assets/images/Logos/Current/kia.jpg" },
    { id: 4, name: "Toyota", logo: "../../src/assets/images/Logos/Current/toyota.jpg" },
    { id: 5, name: "Hyundai", logo: "../../src/assets/images/Logos/Current/hyundai.jpg" },
    { id: 6, name: "Mahindra", logo: "../../src/assets/images/Logos/Current/mahindra.jpg" },
    { id: 7, name: "Honda", logo: "../../src/assets/images/Logos/Current/honda.jpg" },
    { id: 8, name: "MG", logo: "../../src/assets/images/Logos/Current/mg.jpg" },
    { id: 9, name: "Skoda", logo: "../../src/assets/images/Logos/Current/skoda.jpg" },
    { id: 10, name: "Jeep", logo: "../../src/assets/images/Logos/Current/jeep.jpg" },
    { id: 11, name: "Renault", logo: "../../src/assets/images/Logos/Current/renault.jpg" },
    { id: 12, name: "Nissan", logo: "../../src/assets/images/Logos/Current/nissan.jpg" },
    { id: 13, name: "Volkswagen", logo: "../../src/assets/images/Logos/Current/volkswagen.jpg" },
    { id: 14, name: "Citroen", logo: "../../src/assets/images/Logos/Current/citroen.jpg" },
    { id: 15, name: "Aston Martin", logo: "../../src/assets/images/Logos/Current/aston-martin.jpg" },
    { id: 16, name: "Audi", logo: "../../src/assets/images/Logos/Current/audi.jpg" },
    { id: 17, name: "Bajaj", logo: "../../src/assets/images/Logos/Current/bajaj.jpg" },
    { id: 18, name: "Bentley", logo: "../../src/assets/images/Logos/Current/bentley.jpg" },
    { id: 19, name: "BMW", logo: "../../src/assets/images/Logos/Current/bmw.jpg" },
    { id: 20, name: "BYD", logo: "../../src/assets/images/Logos/Current/byd.jpg" },
    { id: 21, name: "Ferrari", logo: "../../src/assets/images/Logos/Current/ferrari.jpg" },
    { id: 22, name: "Force", logo: "../../src/assets/images/Logos/Current/force.jpg" },
    { id: 23, name: "Isuzu", logo: "../../src/assets/images/Logos/Current/isuzu.jpg" },
    { id: 24, name: "Jaguar", logo: "../../src/assets/images/Logos/Current/jaguar.jpg" },
    { id: 25, name: "Haval", logo: "../../src/assets/images/Logos/Upcoming/haval.jpg" },
    { id: 26, name: "Koeinigsegg", logo: "../../src/assets/images/Logos/Upcoming/koenigsegg.jpg" },
    { id: 27, name: "Mahindra BE", logo: "../../src/assets/images/Logos/Upcoming/mahindra-be.jpg" },
    { id: 28, name: "Mahindra XUV", logo: "../../src/assets/images/Logos/Upcoming/mahindra-xuv.jpg" },
    { id: 29, name: "Mean Metal", logo: "../../src/assets/images/Logos/Upcoming/mean-metal.jpg" },
    { id: 30, name: "Vayve Mobility", logo: "../../src/assets/images/Logos/Upcoming/vayve-mobility.jpg" },
    { id: 31, name: "Vinfast", logo: "../../src/assets/images/Logos/Upcoming/vinfast.jpg" },
    { id: 32, name: "Xiaomi", logo: "../../src/assets/images/Logos/Upcoming/xiaomi.jpg" },
    { id: 33, name: "Ashok-Leylond", logo: "../../src/assets/images/Logos/Expired/ashok-leylond.jpg" },
    { id: 34, name: "Austin", logo: "../../src/assets/images/Logos/Expired/austin.jpg" },
    { id: 35, name: "Cadillac", logo: "../../src/assets/images/Logos/Expired/cadillac.jpg" },
    { id: 36, name: "Caterham", logo: "../../src/assets/images/Logos/Expired/caterham.jpg" },
    { id: 37, name: "Chevrolet", logo: "../../src/assets/images/Logos/Expired/chevrolet.jpg" },
    { id: 38, name: "Chrysler", logo: "../../src/assets/images/Logos/Expired/chrysler.jpg" },
    { id: 39, name: "Conquest", logo: "../../src/assets/images/Logos/Expired/conquest.jpg" },
    { id: 40, name: "Daewoo", logo: "../../src/assets/images/Logos/Expired/daewoo.jpg" },
    { id: 41, name: "Datsun", logo: "../../src/assets/images/Logos/Expired/datsun.jpg" },
    { id: 42, name: "DC", logo: "../../src/assets/images/Logos/Expired/dc.jpg" },
    { id: 43, name: "Dodge", logo: "../../src/assets/images/Logos/Expired/dodge.jpg" },
    { id: 44, name: "Fiat", logo: "../../src/assets/images/Logos/Expired/fiat.jpg" },
    { id: 45, name: "Hummer", logo: "../../src/assets/images/Logos/Expired/hummer.jpg" },
    { id: 46, name: "Icml", logo: "../../src/assets/images/Logos/Expired/icml.jpg" },
    { id: 47, name: "Infiniti", logo: "../../src/assets/images/Logos/Expired/infiniti.jpg" },
    { id: 48, name: "Mahindra-Ssangyong", logo: "../../src/assets/images/Logos/Expired/mahindra-ssangyong.jpg" },
    { id: 49, name: "Maybach", logo: "../../src/assets/images/Logos/Expired/maybach.jpg" },
    { id: 50, name: "Mazda", logo: "../../src/assets/images/Logos/Expired/mazda.jpg" },
    { id: 51, name: "Morris", logo: "../../src/assets/images/Logos/Expired/morris.jpg" },
    { id: 52, name: "Reva", logo: "../../src/assets/images/Logos/Expired/reva.jpg" },
]
